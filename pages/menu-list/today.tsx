...
import { getLists,addTodo, getTodos, completeTodo } from "../api/API"
...
const MenuDetailPage = () => {
    ...
    .then(
        ({ data: { lists } }: IList[] | any) => setLists(lists)
    )
                    ...
                    return (
                        <div key={item._id} className="mb-4">
                            ...
                            {todos.map((todo) => {
                                return(
                                    <div key={todo._id}>                                       
                                        {item._id === todo.list_id && remove !== todo._id && getDateMatch(todo.datePicked) == TodayDate && todo.datePicked !== ' ' && todo.completed === false  ? 
